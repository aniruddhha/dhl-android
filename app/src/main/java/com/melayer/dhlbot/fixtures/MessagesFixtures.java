package com.melayer.dhlbot.fixtures;
...
public final class MessagesFixtures extends FixturesData {
    ...
    public static Message botMsg(String msg) {
        return new Message(getRandomId(), botUser(), msg);
    }

    public static Message pandaMsg(String msg) {
        return new Message(getRandomId(), pandaUser(), msg);
    }
    ...
    private static User botUser() {
        return new User("1", "Lucy", "http://i.imgur.com/pv1tBmT.png", true);
    }

    private static User pandaUser() {
        return new User("0", "gaga", "http://i.imgur.com/Qn9UesZ.png", true);
    }
}
